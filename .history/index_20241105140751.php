...
<body>
    ...
    <nav>
        <ul>
        <li><a href="views/associado/cadastrar.php">Cadastrar Novo Associado</a></li>
<li><a href="views/associado/listar.php">Listar Associados</a></li>
<li><a href="views/anuidade/cadastrar.php">Cadastrar Nova Anuidade</a></li>
<li><a href="views/anuidade/listar.php">Listar Anuidades</a></li>
<li><a href="views/pagamento/checkout.php">Checkout de Anuidades</a></li>
<li><a href="views/relatorio/status_pagamento.php">Status de Pagamento dos Associados</a></li>
        </ul>
    </nav>
