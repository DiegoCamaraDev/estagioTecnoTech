    ...
    <table border="1">
        ...
        <?php foreach ($associados as $associado): ?>
            <tr>
                ...
                <td>
                    <a href="../../controllers/AssociadoController.php?action=edit&id=<?php echo $associado['id']; ?>">Editar</a> |
                    <a href="../../controllers/AssociadoController.php?action=delete&id=<?php echo $associado['id']; ?>" onclick="return confirm('Tem certeza que deseja excluir este associado?');">Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
