...
$associado = $associadoModel->listarPorId($associado_id);
if (!$associado) {
...
$dataFiliacao = new DateTime($associado['data_filiacao']);
$anoAtual = (int) date("Y");
$anuidades = $anuidadeModel->listar(); // Listando todas as anuidades cadastradas
...
(); // Listando todas as anuidades cadastradas
$pagamentos = $pagamentoModel->listarPagamentos($associado_id); // Listando pagamentos feitos pelo associado
